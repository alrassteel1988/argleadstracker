...
function cleanPlace(place) {
  const fields = {
    ...
    latitude: place.location?.latitude == null ? null : Number(place.location.latitude),
    longitude: place.location?.longitude == null ? null : Number(place.location.longitude),
...
function cleanLegacyPlace(place) {
  const fields = {
    ...
    latitude: place.geometry?.location?.lat == null ? null : Number(place.geometry.location.lat),
    longitude: place.geometry?.location?.lng == null ? null : Number(place.geometry.location.lng),
