...
assert.match(html, /activity-dashboard-latest\.css\?v=weekly-calendar-flow-1/, "Latest Activity CSS must use the weekly-calendar cache-busting revision");
assert.ok(
...
assert.match(serviceWorker, /arg-pwa-v70-weekly-calendar-flow/, "The PWA cache must be bumped when Activity CSS changes");
